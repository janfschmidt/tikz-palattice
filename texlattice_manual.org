...
*** Labels
  ...
  - \verb+\begin{labeldistance}{distance/m}+ ... \verb+\end{labeldistance}+ set distance of text labels to element center for all elements within this environment (default is 0.35)
