...
\def\scale{0.5}
\newcommand{\driftcolor}{\setlinecolor{drift}{red!70!black}}
...
%text
\node[font=\Large,scale=2, align=center, yshift=5mm, anchor=east, text width=3cm] at (bestrahlung)
{Bestrahlungs\-platz};
...
%Photon-Beamline
\goto{CBphotons}
\setlinecolor{drift}{black}
\drift{18}
\beamdump{photon camera}{0.4}[0.2]
\driftcolor

%title
\node[font=\Large,scale=2, anchor=east, yshift=1.5cm] at (CBlabel) {Crystal Barrel};
\node[font=\Huge,scale=2, align=center, yshift=3.8cm,xshift=-1.8cm, text width=6cm] at (CBlabel)
...
%-------------------
  ...
  \turnlabels
  \drift{1.03}                                                               
  \dipole{MB2}{1.08166}{-11.0008}[r][0.6]
  \drift{1.06}                                                               
  \quadrupole{QF2}{0.45}                                                     
  \drift{1.32}             
  \rotatelabels{90}[west]                                                  
